package cz.cvut.linviz.view.component;
...
public class CustomCheckbox extends AbstractButton {
    ...
    private Color red = new Color(221, 86, 93);
    private Color green = new Color(104, 195, 94);
    ...
    public CustomCheckbox(String trueLabel, String falseLabel, boolean selected) {
